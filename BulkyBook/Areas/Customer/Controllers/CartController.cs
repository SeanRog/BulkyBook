    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ShoppingCartVM = new ShoppingCartVM()
            {
                ...
                ListCart = _unitOfWork.ShoppingCart.GetAll(u=>u.ApplicationUserId == claim.Value, includeProperties:"Product") //get all based on user Id
            };
        ...
        public async Task<IActionResult> IndexPost()
        {
            ...
            if(user == null)
            {
                ModelState.AddModelError(string.Empty, "Verificatoin email is empty!");
            }
